...
public class CookingController {
    ...
    @RequestMapping(
        value = "cookings/{id}/accepte-or-reject",
        method = RequestMethod.PUT,
        produces = "application/json;charset=UTF-8"
    )
    public Cooking accepteOrReject(
        @PathVariable(value = "id") Long id,
        @RequestBody AccepteOrRejectCommand accepteOrRejectCommand,
        HttpServletRequest request,
        HttpServletResponse response
    ) throws Exception {
        System.out.println("##### /cooking/accepteOrReject  called #####");
        ...
        cooking.accepteOrReject(accepteOrRejectCommand);
